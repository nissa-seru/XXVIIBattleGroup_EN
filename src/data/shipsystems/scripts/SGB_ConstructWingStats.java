	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		if (effectLevel == 1) {
			...
			for (FighterLaunchBayAPI bay : ship.getLaunchBaysCopy()) {
				...
				String wingID = bay.getWing().getSpec().getId();
				String wingID2 = bay.getWing().getWingId();
				ShipAPI wingLeader = bay.getWing().getLeader();
				ShipVariantAPI LeaderID = bay.getWing().getLeader().getVariant();
				Vector2f loc;
				if(wingLeader != null){
				...
				if(leader != null) {
					...
					/*
					Global.getLogger(this.getClass()).info("SGB_CONWING_Get to DO the wingBug ---i:" + i);
					Global.getLogger(this.getClass()).info("SGB_CONWING_Get to DO the wingBug ---leader:" + leader);
					Global.getLogger(this.getClass()).info("SGB_CONWING_Get to DO the wingBug ---getWing:" + leader.getWing());
					Global.getLogger(this.getClass()).info("SGB_CONWING_Get to DO the wingBug ---getWingMembers:" + leader.getWing().getWingMembers());
					Global.getLogger(this.getClass()).info("SGB_CONWING_Get to DO the wingBug ---get(i):" + leader.getWing().getWingMembers().get(i));*/
