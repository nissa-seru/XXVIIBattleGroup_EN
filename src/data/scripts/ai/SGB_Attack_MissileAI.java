//Form MagicMissileAI By Tartiflette.
...
public class SGB_Attack_MissileAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    private final float WAVE_TIME = 0.5f;
    ...
    public SGB_Attack_MissileAI(MissileAPI missile, ShipAPI launchingShip) {
